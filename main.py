...
def run():
    ...
    parser.add_argument("--partition_type", type=str, default="noniid_class", choices=["iid", "successive", "empty", "share",
                                                                              "noniid_class", "noniid_class_unbalance",
                                                                              "noniid_dir","fixiid","fixnoniid","fixdir"],
    ...
    parser.add_argument("--model", choices=["rnn", "resnet", "resnet18", "resnet50",
                                            ...
                                            "linear_regression", "logistic_regression","cnn_mnist","convex_linear","mnistnet","resnet18_mnist"],
    ...
    parser.add_argument("--test_every_iteration", type=int, default=100, help="the interval of test.")
    ...
    parser.add_argument("--lr_controller", type=str, default="OneOverSqrtKLr", choices=["ConstantLr", "OneOverSqrtKLr",
                                                                                    "OneOverKLr","OneOverKLrC", "LadderLr",
                                                                                    "ConstantThenDecreasingLr",
                                                                                    "DecreasingStepLr",
                                                                                    "FollowOne"],
                        help="learning rate type.")
    parser.add_argument("--init_lr", type=float, default=0.1, help="")
    parser.add_argument("--init_momentum", type=float, default=0.03,
                        help="The momentum in SGD optimizer equal with 1-init_momentum")
    parser.add_argument("--graph_type", type=str, default="ErdosRenyi", choices=["CompleteGraph", "ErdosRenyi",
    ...
    parser.add_argument("--print_interval", type=int, default=100, help="")
    parser.add_argument("--byzantine_cnt", type=int, default=0, help="The byzantine nodes in graph.")
    ...
    parser.add_argument("--attack_type", type=str, default="Gaussian", choices=["NoAttack", "Gaussian", "SignFlipping",
                                                                                "SampleDuplicating", "ZeroValue",
                                                                                "Isolation", "LittleEnough","AGRFang",
                                                                                "AGRTailored"], help="")
    parser.add_argument("--seed", type=int, default=3407, help="3407")
    ...
    config = {
        ...
        "controller": {"nodes_per_round": args.nodes_cnt, "random_selection": False,
                       ...
                       "test_every_iteration": args.test_every_iteration,"print_interval": args.print_interval},
        "lr_controller_param": {"init_lr": args.init_lr, "init_momentum": args.init_momentum},
        "aggregation_param": {"exact_byz_cnt": False, "byz_cnt": 2, "weight_mh": True,
                              "threshold_selection": "parameter", "threshold": 0.1},
        "attacks_param": {"use_honest_mean": False, "sign_scale": -1, "little_scale": None},
