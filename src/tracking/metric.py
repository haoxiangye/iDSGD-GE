...
TEST_ACCURACY_IN_TRAIN ='test_accuracy_in_train'
TEST_LOSS_IN_TRAIN='test_loss_in_train'
TEST_DATA_SIZE_IN_TRAIN='test_data_size_in_train'

#对应
TEST_IN_TRAIN_AVG_MODEL_ACCURACY = 'test_in_train_avg_model_accuracy'
TEST_IN_TRAIN_AVG_MODEL_LOSS = 'test_in_train_avg_model_loss'
GENE = 'gene'
MAX_GENE = 'max_gene'

AVG_MODEL_GENE = 'avg_model_gene'
