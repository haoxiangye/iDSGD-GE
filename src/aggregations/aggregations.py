...
class TrimmedMean(DistributedAggregation):
    ...
    def __init__(self, graph, conf=None, exact_byz_cnt=False, byz_cnt=2, *args, **kwargs):
    ...
    @staticmethod
    def get_trimmed_number(graph, selected_nodes_cid, exact_byz_cnt=False, byz_cnt=2):
...
class IOS(DistributedAggregation):
    ...
    def __init__(self, graph, conf=None, weight_mh=True, exact_byz_cnt=False, byz_cnt=2, *args, **kwargs):
...
class CenteredClipping(DistributedAggregation):
    ...
    def __init__(self, graph, conf=None, weight_mh=True, threshold_selection='parameter',
                 threshold=0.1, *args, **kwargs):
